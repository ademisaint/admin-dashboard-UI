...
const SignIn = () => {
  ...
  return (
    <div className='flex justify-end bg-white dark:bg-[#0B1437] font-dmsans'>
      <div className='w-[50%] flex justify-around p-[30px]'>
        <div className='flex flex-col justify-between'>
          ...
          <div className=''>
            <div>
              <h1 className='text-[32px] text-[#2B3674] dark:text-white font-bold'>Sign In</h1>
              <p className='text-[14px] font-light text-[#A3AED0] py-[4px]'>Enter your email and password to sign in!</p>
              <button className='flex items-center bg-[#F4F7FE] dark:bg-[#1B254B] w-[100%] justify-center rounded-[12px] py-[10px] text-[14px] my-4'><img src={google} alt="" className=' w-4 h-4 mx-[8px]' />Sign in with Google</button>
            </div>
            <div className="my-[10px] mx-[0px] text-center w-[100%]">or</div>
            <div className='form'>
              <div>
                <p className=' text-[14px] text-[#2B3674] dark:text-white font-medium'>Email<span className='text-[#4318FF]'>&#42;</span></p>
                <input 
                  type="text" 
                  placeholder='mail@sample.com'
                  className='rounded-[12px] border-[#dee3f0] dark:border-[#9aa1b7] dark:bg-[#0B1437] w-[350px] px-6 my-3 text-[14px]'
                />
              </div>
              <div>
                <p className=' text-[14px] text-[#2B3674] dark:text-white font-medium'>Password<span className='text-[#4318FF]'>&#42;</span></p>
                <input 
                  type="text" 
            ...
            <div className='flex justify-between my-3'>
              <div className='flex items-center'>
                ...
                <p className='text-[#2B3674] dark:text-white text-[12px] font-normal pl-[10px]'>Keep me logged in</p>
              </div>
              <a href="#" className='text-[#4318FF] dark:text-white font-medium text-[14px]'>Forgot Password?</a>
            </div>
            <button className='bg-[#4318FF] text-[white] text-[12px] font-bold w-[100%] py-[10px] rounded-[16px] my-3'>Sign In</button>
            <div>
              <p className='text-[12px] text-[#2B3674] dark:text-[#A3AED0]'>Not registered yet? <a href="#" className='text-[#4318FF] dark:text-white font-bold'>Create and Account</a></p>
            </div>
          </div>
